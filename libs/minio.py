# ~/~ begin <<docs/gong-web-app/storage-minio.md#libs/minio.py>>[init]
...
# ~/~ begin <<docs/gong-web-app/storage-minio.md#define-client>>[init]
...
# ~/~ end
# ~/~ begin <<docs/gong-web-app/storage-minio.md#get-objects-alist>>[init]
...
# ~/~ end
# ~/~ begin <<docs/gong-web-app/storage-minio.md#file-upload>>[init]
...
def file_upload(bucket, the_object, file_to_upload):
    ...
    return result
# ~/~ end
# ~/~ begin <<docs/gong-web-app/storage-minio.md#file-download>>[init]
...
# ~/~ end
# ~/~ begin <<docs/gong-web-app/storage-minio.md#get-save-temp-files>>[init]
...
# ~/~ end
# ~/~ begin <<docs/gong-web-app/storage-minio.md#get-save-excel-files>>[init]
