# ~/~ begin <<docs/gong-web-app/gong-timings-chan.md#libs/timechan.py>>[init]
...
# ~/~ begin <<docs/gong-web-app/gong-timings-chan.md#repaint-timings>>[init]
...
# ~/~ end
# ~/~ begin <<docs/gong-web-app/gong-timings-chan.md#change-timetables>>[init]
...
# ~/~ end
# ~/~ begin <<docs/gong-web-app/gong-timings-chan.md#change-struct>>[init]
...
# ~/~ end
# ~/~ begin <<docs/gong-web-app/gong-timings-chan.md#change-period>>[init]
